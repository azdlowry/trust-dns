...
use trust_dns_proto::xfer::{
    DnsExchange, DnsExchangeConnect, DnsRequestSender, DnsRequestStreamHandle, DnsResponse,
};
...
pub trait ClientConnection: Sized {
    ...
    type Response: Future<Item = DnsResponse, Error = ProtoError> + Send;
    /// A future that resolves to the RequestSender
    type SenderFuture: Future<Item = Self::Sender, Error = ProtoError>;
